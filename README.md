<h1 align="center"> 
  Consumindo API Encurtador de URL
</h1>
...
**Encurtador de URL** - Aplicação desenvolvida para praticar o desenvolvimento de uma aplicação com VueJS 3 e Vuetify 3, consumindo uma API gratuita.
...
Este projeto esta sobe a licença [MIT](https://github.com/JacksonSantin/shortner-url/blob/master/LICENSE).
